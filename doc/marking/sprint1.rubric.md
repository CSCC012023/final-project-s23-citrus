...
## User Stories (Tracked in JIRA) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1 (Acceptance criteria should be more detailed, but is a good start) 
...
Your Mark: 0 (No mention of ticket number in commit message)
  ...
  - Branch Naming (max 2 marks)
    ...
    Your Mark: 1 (Some branches aren't named after a ticket number)
