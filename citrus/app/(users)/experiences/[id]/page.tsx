...
export function QRCodeComponent({ value }: QRCodeComponentProps) {
...
export default async function Page({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="w-9/12 m-auto">
            ...
            <div>
                <h2 className="text-3xl text-bold">Your Ticket:</h2>
                <QRCodeComponent value={ticketValue} />
