    ...
    return (
        <div className="w-9/12 m-auto">
            ...
            <button
                ...
                className="absolute top-12 right-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
            >
                Print Ticket
            </button>
            </div>

            {/* Show the QR code if showQRCode state is true */}
            {showQRCode && (
                <div className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-75 flex items-center justify-center">
                <div className="bg-white p-8 rounded-lg">
                <QRCode value={generateQRCodeContent()} size={128} />
                    <button
