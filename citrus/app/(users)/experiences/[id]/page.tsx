      ...
      <div className="w-9/12 m-auto">
        ...
        <div className='flex flex-row space-x-20 justify-center my-5'>
          <div>
            ...
            <p className=''>{start_time.toLocaleString([], {dateStyle: 'long', timeStyle: 'short'})} to <br />{end_time.toLocaleString([], {dateStyle: 'long', timeStyle: 'short'})}</p>
          </div>
          <div>
        ...
        <div>
          <QRCode value={`EventID:${params.id}`} size={128} />
        </div>
        </div>
);
}
